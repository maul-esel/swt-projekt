...
namespace MobileApp.iOS.Tests
{
	...
	public class PlayerTests
	{
		...
		public void Init()
		{
			...
			var bundleFileUrl = Path.Combine(NSBundle.MainBundle.BundlePath, "TestContent/" + testFileName);
			var bundleFileBytes = File.ReadAllBytes(bundleFileUrl);

			//Create filePath to iOS default documents directory
			...
			File.WriteAllBytes(testFilePath, bundleFileBytes);
